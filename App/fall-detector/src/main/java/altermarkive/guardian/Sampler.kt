        ...
        for (sensor in list) {
            when (sensor.type) {
                Sensor.TYPE_ACCELEROMETER -> {
                    manager.registerListener(this, sensor, Tracker.INTERVAL_MS * 1000)
                }
            }
        }
    }
